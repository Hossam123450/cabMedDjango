...
#     }
#     return render(request,'index1.html',contexte)
...
def cab2(request):
    ...
    return render(request,'index2.html',contexte)
...
def cab3(request):
    ...
    return render(request,'index3.html',contexte)
...
def cab4(request):
    ...
    return render(request,'index4.html',contexte)
